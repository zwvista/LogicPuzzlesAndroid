...
class HeliumAndIronGame(layout: List<String>, gi: GameInterface<HeliumAndIronGame, HeliumAndIronGameMove, HeliumAndIronGameState>, gdi: GameDocumentInterface) : CellsGame<HeliumAndIronGame, HeliumAndIronGameMove, HeliumAndIronGameState>(gi, gdi) {
    companion object {
    ...
    val dots: GridDots
    val objArray: Array<HeliumAndIronObject>

    operator fun get(row: Int, col: Int) = objArray[row * cols + col]
    operator fun get(p: Position) = this[p.row, p.col]
    operator fun set(row: Int, col: Int, obj: HeliumAndIronObject) {objArray[row * cols + col] = obj}
    ...
    init {
        ...
        objArray = Array(rows * cols) { HeliumAndIronObject.Empty }
        ...
        val state = HeliumAndIronGameState(this)
