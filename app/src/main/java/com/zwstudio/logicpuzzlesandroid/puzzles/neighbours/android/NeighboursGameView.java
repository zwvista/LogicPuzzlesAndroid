...
public class NeighboursGameView extends CellsGameView {
    ...
    private NeighboursGame game() {return activity().game;}
    ...
    public NeighboursGameView(Context context) {
        super(context);
        init(null, 0);
    }

    public NeighboursGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public NeighboursGameView(Context context, AttributeSet attrs, int defStyle) {
...
//        canvas.drawColor(Color.BLACK);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN && !game().isSolved()) {
            ...
            NeighboursGameMove move = new NeighboursGameMove() {{
