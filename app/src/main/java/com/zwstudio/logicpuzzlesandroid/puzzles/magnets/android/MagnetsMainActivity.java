...
@EActivity(R.layout.activity_magnets_main)
public class MagnetsMainActivity extends MainActivity<MagnetsGame, MagnetsDocument, MagnetsGameMove, MagnetsGameState> {
