...
class FreePlanksGame(layout: List<String>, gi: GameInterface<FreePlanksGame, FreePlanksGameMove, FreePlanksGameState>, gdi: GameDocumentInterface) : CellsGame<FreePlanksGame, FreePlanksGameMove, FreePlanksGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = FreePlanksGameState(this)
