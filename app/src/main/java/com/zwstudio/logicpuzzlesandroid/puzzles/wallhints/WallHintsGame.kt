...
class WallHintsGame(layout: List<String>, gi: GameInterface<WallHintsGame, WallHintsGameMove, WallHintsGameState>, gdi: GameDocumentInterface) : CellsGame<WallHintsGame, WallHintsGameMove, WallHintsGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = WallHintsGameState(this)
