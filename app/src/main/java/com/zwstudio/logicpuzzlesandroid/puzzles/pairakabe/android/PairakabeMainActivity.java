...
@EActivity(R.layout.activity_pairakabe_main)
public class PairakabeMainActivity extends MainActivity<PairakabeGame, PairakabeDocument, PairakabeGameMove, PairakabeGameState> {
