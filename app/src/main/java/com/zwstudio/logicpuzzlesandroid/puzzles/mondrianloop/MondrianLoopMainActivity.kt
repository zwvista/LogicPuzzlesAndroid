...
class MondrianLoopMainActivity : GameMainActivity<MondrianLoopGame, MondrianLoopDocument, MondrianLoopGameMove, MondrianLoopGameState>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOptions.setOnClickListener {
            startActivity(Intent(this, MondrianLoopOptionsActivity::class.java))
        }
    }

    override fun resumeGame() {
        doc.resumeGame()
        startActivity(Intent(this, MondrianLoopGameActivity::class.java))
    }
}

class MondrianLoopOptionsActivity : GameOptionsActivity<MondrianLoopGame, MondrianLoopDocument, MondrianLoopGameMove, MondrianLoopGameState>() {
    private val document: MondrianLoopDocument by inject()
    override val doc get() = document
...
class MondrianLoopHelpActivity : GameHelpActivity<MondrianLoopGame, MondrianLoopDocument, MondrianLoopGameMove, MondrianLoopGameState>() {
    private val document: MondrianLoopDocument by inject()
    override val doc get() = document
}