...
class AssemblyInstructionsGame(layout: List<String>, gi: GameInterface<AssemblyInstructionsGame, AssemblyInstructionsGameMove, AssemblyInstructionsGameState>, gdi: GameDocumentInterface) : CellsGame<AssemblyInstructionsGame, AssemblyInstructionsGameMove, AssemblyInstructionsGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = AssemblyInstructionsGameState(this)
