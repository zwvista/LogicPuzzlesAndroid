...
class UnseenGame(layout: List<String>, gi: GameInterface<UnseenGame, UnseenGameMove, UnseenGameState>, gdi: GameDocumentInterface) : CellsGame<UnseenGame, UnseenGameMove, UnseenGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = UnseenGameState(this)
