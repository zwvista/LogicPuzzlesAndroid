...
public class ParkLakesGameActivity extends GameGameActivity<ParkLakesGame, ParkLakesDocument, ParkLakesGameMove, ParkLakesGameState> {
    @Bean
    protected ParkLakesDocument document;
    public ParkLakesDocument doc() {return document;}

    protected ParkLakesGameView gameView;
    protected View getGameView() {return gameView;}

    @AfterViews
    protected void init() {
        gameView = new ParkLakesGameView(this);
        super.init();
    }
    ...
    protected void startGame() {
        ...
        game = new ParkLakesGame(level.layout, this, doc());
        try {
            // restore game state
            for (MoveProgress rec : doc().moveProgress()) {
                ParkLakesGameMove move = doc().loadMove(rec);
                game.setObject(move);
            }
