...
class WildlifeParkMainActivity : GameMainActivity<WildlifeParkGame, WildlifeParkDocument, WildlifeParkGameMove, WildlifeParkGameState>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOptions.setOnClickListener {
            startActivity(Intent(this, WildlifeParkOptionsActivity::class.java))
        }
    }

    override fun resumeGame() {
        doc.resumeGame()
        startActivity(Intent(this, WildlifeParkGameActivity::class.java))
    }
}

class WildlifeParkOptionsActivity : GameOptionsActivity<WildlifeParkGame, WildlifeParkDocument, WildlifeParkGameMove, WildlifeParkGameState>() {
    private val document: WildlifeParkDocument by inject()
    override val doc get() = document
...
class WildlifeParkHelpActivity : GameHelpActivity<WildlifeParkGame, WildlifeParkDocument, WildlifeParkGameMove, WildlifeParkGameState>() {
    private val document: WildlifeParkDocument by inject()
    override val doc get() = document
}