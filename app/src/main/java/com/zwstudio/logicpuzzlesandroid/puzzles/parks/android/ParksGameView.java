...
public class ParksGameView extends CellsGameView {
    ...
    private ParksGame game() {return activity().game;}
    ...
    public ParksGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public ParksGameView(Context context, AttributeSet attrs, int defStyle) {
