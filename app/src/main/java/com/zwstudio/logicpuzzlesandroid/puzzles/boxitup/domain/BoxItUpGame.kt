...
class BoxItUpGame(layout: List<String>, gi: GameInterface<BoxItUpGame?, BoxItUpGameMove?, BoxItUpGameState?>?, gdi: GameDocumentInterface?) : CellsGame<BoxItUpGame?, BoxItUpGameMove?, BoxItUpGameState?>(gi, gdi) {
    ...
    private fun changeObject(move: BoxItUpGameMove?, f: F2<BoxItUpGameState?, BoxItUpGameMove?, Boolean>): Boolean {
        if (canRedo()) {
    ...
    fun switchObject(move: BoxItUpGameMove?): Boolean {
        return changeObject(move, F2 { obj: BoxItUpGameState?, move: BoxItUpGameMove? -> obj!!.switchObject(move) })
    }

    fun setObject(move: BoxItUpGameMove?): Boolean {
        return changeObject(move, F2 { obj: BoxItUpGameState?, move: BoxItUpGameMove? -> obj!!.setObject(move) })
    }
