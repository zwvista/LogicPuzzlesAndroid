...
@EActivity(R.layout.activity_neighbours_main)
public class NeighboursMainActivity extends MainActivity<NeighboursGame, NeighboursDocument, NeighboursGameMove, NeighboursGameState> {
