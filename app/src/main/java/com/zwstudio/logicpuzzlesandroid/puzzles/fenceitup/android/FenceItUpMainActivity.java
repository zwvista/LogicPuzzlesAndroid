...
@EActivity(R.layout.activity_fenceitup_main)
public class FenceItUpMainActivity extends MainActivity<FenceItUpGame, FenceItUpDocument, FenceItUpGameMove, FenceItUpGameState> {
