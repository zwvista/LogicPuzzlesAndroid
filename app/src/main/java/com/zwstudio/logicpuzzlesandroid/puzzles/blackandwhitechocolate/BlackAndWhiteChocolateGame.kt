...
class BlackAndWhiteChocolateGame(layout: List<String>, gi: GameInterface<BlackAndWhiteChocolateGame, BlackAndWhiteChocolateGameMove, BlackAndWhiteChocolateGameState>, gdi: GameDocumentInterface) : CellsGame<BlackAndWhiteChocolateGame, BlackAndWhiteChocolateGameMove, BlackAndWhiteChocolateGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = BlackAndWhiteChocolateGameState(this)
