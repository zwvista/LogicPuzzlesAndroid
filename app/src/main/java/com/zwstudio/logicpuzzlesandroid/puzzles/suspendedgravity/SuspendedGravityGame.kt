...
class SuspendedGravityGame(layout: List<String>, gi: GameInterface<SuspendedGravityGame, SuspendedGravityGameMove, SuspendedGravityGameState>, gdi: GameDocumentInterface) : CellsGame<SuspendedGravityGame, SuspendedGravityGameMove, SuspendedGravityGameState>(gi, gdi) {
    companion object {
