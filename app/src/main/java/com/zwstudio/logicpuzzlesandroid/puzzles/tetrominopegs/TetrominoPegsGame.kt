...
class TetrominoPegsGame(layout: List<String>, gi: GameInterface<TetrominoPegsGame, TetrominoPegsGameMove, TetrominoPegsGameState>, gdi: GameDocumentInterface) : CellsGame<TetrominoPegsGame, TetrominoPegsGameMove, TetrominoPegsGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = TetrominoPegsGameState(this)
