...
class FlowerbedShrubsGame(layout: List<String>, gi: GameInterface<FlowerbedShrubsGame, FlowerbedShrubsGameMove, FlowerbedShrubsGameState>, gdi: GameDocumentInterface) : CellsGame<FlowerbedShrubsGame, FlowerbedShrubsGameMove, FlowerbedShrubsGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = FlowerbedShrubsGameState(this)
