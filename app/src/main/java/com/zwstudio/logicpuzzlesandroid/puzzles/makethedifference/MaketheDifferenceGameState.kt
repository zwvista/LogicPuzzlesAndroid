...
class MaketheDifferenceGameState(game: MaketheDifferenceGame) : CellsGameState<MaketheDifferenceGame, MaketheDifferenceGameMove, MaketheDifferenceGameState>(game) {
    ...
    override fun setObject(move: MaketheDifferenceGameMove): GameChangeType {
        val dir = move.dir
        val dir2 = (dir + 2) % 4
        val p1 = move.p
    ...
    override fun switchObject(move: MaketheDifferenceGameMove): GameChangeType {
    ...
    */
    private fun updateIsSolved() {
        ...
        while (pos2node.isNotEmpty()) {
            ...
            val s = if (rs * cs == n1 && abs(rs - cs) == n2 && !hasLine()) HintState.Complete else HintState.Error
            pos2state[p2] = s
