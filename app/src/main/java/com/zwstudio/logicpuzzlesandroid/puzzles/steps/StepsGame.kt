...
class StepsGame(layout: List<String>, gi: GameInterface<StepsGame, StepsGameMove, StepsGameState>, gdi: GameDocumentInterface) : CellsGame<StepsGame, StepsGameMove, StepsGameState>(gi, gdi) {
    companion object {
