...
class DirectionalPlanksGame(layout: List<String>, gi: GameInterface<DirectionalPlanksGame, DirectionalPlanksGameMove, DirectionalPlanksGameState>, gdi: GameDocumentInterface) : CellsGame<DirectionalPlanksGame, DirectionalPlanksGameMove, DirectionalPlanksGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = DirectionalPlanksGameState(this)
