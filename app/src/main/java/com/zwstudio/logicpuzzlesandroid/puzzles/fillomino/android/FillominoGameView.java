...
public class FillominoGameView extends CellsGameView {
    ...
    private FillominoGame game() {return activity().game;}
    ...
    public FillominoGameView(Context context) {
        super(context);
        init(null, 0);
    }

    public FillominoGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public FillominoGameView(Context context, AttributeSet attrs, int defStyle) {
...
//        canvas.drawColor(Color.BLACK);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN && !game().isSolved()) {
            ...
            FillominoGameMove move = new FillominoGameMove() {{
