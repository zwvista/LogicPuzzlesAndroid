...
@EActivity(R.layout.activity_skyscrapers_main)
public class SkyscrapersMainActivity extends MainActivity<SkyscrapersGame, SkyscrapersDocument, SkyscrapersGameMove, SkyscrapersGameState> {
