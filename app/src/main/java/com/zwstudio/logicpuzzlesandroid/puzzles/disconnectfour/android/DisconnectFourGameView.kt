...
class DisconnectFourGameView : CellsGameView {
    private fun activity(): DisconnectFourGameActivity {
        return context as DisconnectFourGameActivity
    }

    private fun game(): DisconnectFourGame? {
