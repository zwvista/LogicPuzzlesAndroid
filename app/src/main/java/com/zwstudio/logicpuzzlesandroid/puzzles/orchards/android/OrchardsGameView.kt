...
_
class OrchardsGameView : CellsGameView {
    private fun activity() = getContext() as OrchardsGameActivity
...
//        canvas.drawColor(Color.BLACK);
        ...
        for (r in 0 until rows()) for (c in 0 until cols()) {
            ...
            if (o is OrchardsTreeObject) {
                val o2: OrchardsTreeObject = o as OrchardsTreeObject
                ...
                dTree!!.draw(canvas)
            } else if (o is OrchardsMarkerObject) canvas.drawArc(cwc2(c) - 20.toFloat(), chr2(r) - 20.toFloat(), cwc2(c) + 20.toFloat(), chr2(r) + 20.toFloat(), 0f, 360f, true, markerPaint) else if (o is OrchardsForbiddenObject) canvas.drawArc(cwc2(c) - 20.toFloat(), chr2(r) - 20.toFloat(), cwc2(c) + 20.toFloat(), chr2(r) + 20.toFloat(), 0f, 360f, true, forbiddenPaint)
        }
    }
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        if (event.getAction() == MotionEvent.ACTION_DOWN && !game().isSolved()) {
            ...
            val move: OrchardsGameMove = object : OrchardsGameMove() {
                init {
                    p = Position(row, col)
                    obj = OrchardsEmptyObject()
                }
            }
