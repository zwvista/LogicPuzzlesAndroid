...
class ZenGardensGame(layout: List<String>, gi: GameInterface<ZenGardensGame, ZenGardensGameMove, ZenGardensGameState>, gdi: GameDocumentInterface) : CellsGame<ZenGardensGame, ZenGardensGameMove, ZenGardensGameState>(gi, gdi) {
    ...
    init {
        ...
        objArray = Array<ZenGardensObject>(rows * cols) { ZenGardensObject.Empty }
        for (r in 0 until rows + 1) {
            ...
            for (c in 0 until cols + 1) {
                ...
                if (c == cols) break
                val ch2 = str[c * 2 + 1]
                this[Position(r, c)] = if (ch2 == ' ') ZenGardensObject.Empty else ZenGardensObject.Stone
            }
        }
        ...
        val state = ZenGardensGameState(this)
