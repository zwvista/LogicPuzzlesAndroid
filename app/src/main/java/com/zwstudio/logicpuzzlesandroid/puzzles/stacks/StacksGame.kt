...
class StacksGame(layout: List<String>, gi: GameInterface<StacksGame, StacksGameMove, StacksGameState>, gdi: GameDocumentInterface) : CellsGame<StacksGame, StacksGameMove, StacksGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = StacksGameState(this)
