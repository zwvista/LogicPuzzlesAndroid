...
class ParksGameView : CellsGameView {
    private fun activity() = getContext() as ParksGameActivity
...
//        canvas.drawColor(Color.BLACK);
        ...
        for (r in 0 until rows()) for (c in 0 until cols()) {
            ...
            if (o is ParksTreeObject) {
                val o2: ParksTreeObject = o as ParksTreeObject
                ...
                dTree!!.draw(canvas)
            } else if (o is ParksMarkerObject) canvas.drawArc(cwc2(c) - 20.toFloat(), chr2(r) - 20.toFloat(), cwc2(c) + 20.toFloat(), chr2(r) + 20.toFloat(), 0f, 360f, true, markerPaint) else if (o is ParksForbiddenObject) canvas.drawArc(cwc2(c) - 20.toFloat(), chr2(r) - 20.toFloat(), cwc2(c) + 20.toFloat(), chr2(r) + 20.toFloat(), 0f, 360f, true, forbiddenPaint)
        }
    }
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        if (event.getAction() == MotionEvent.ACTION_DOWN && !game().isSolved()) {
            ...
            val move = ParksGameMove(Position(row, col))
