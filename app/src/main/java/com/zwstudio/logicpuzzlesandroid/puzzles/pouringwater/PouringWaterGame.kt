...
class PouringWaterGame(layout: List<String>, gi: GameInterface<PouringWaterGame, PouringWaterGameMove, PouringWaterGameState>, gdi: GameDocumentInterface) : CellsGame<PouringWaterGame, PouringWaterGameMove, PouringWaterGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = PouringWaterGameState(this)
