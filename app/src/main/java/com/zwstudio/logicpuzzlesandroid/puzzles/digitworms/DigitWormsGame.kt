...
class DigitWormsGame(layout: List<String>, gi: GameInterface<DigitWormsGame, DigitWormsGameMove, DigitWormsGameState>, gdi: GameDocumentInterface) : CellsGame<DigitWormsGame, DigitWormsGameMove, DigitWormsGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = DigitWormsGameState(this)
