...
class TetrominoPegsMainActivity : GameMainActivity<TetrominoPegsGame, TetrominoPegsDocument, TetrominoPegsGameMove, TetrominoPegsGameState>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOptions.setOnClickListener {
            startActivity(Intent(this, TetrominoPegsOptionsActivity::class.java))
        }
    }

    override fun resumeGame() {
        doc.resumeGame()
        startActivity(Intent(this, TetrominoPegsGameActivity::class.java))
    }
}

class TetrominoPegsOptionsActivity : GameOptionsActivity<TetrominoPegsGame, TetrominoPegsDocument, TetrominoPegsGameMove, TetrominoPegsGameState>() {
    private val document: TetrominoPegsDocument by inject()
    override val doc get() = document
...
class TetrominoPegsHelpActivity : GameHelpActivity<TetrominoPegsGame, TetrominoPegsDocument, TetrominoPegsGameMove, TetrominoPegsGameState>() {
    private val document: TetrominoPegsDocument by inject()
    override val doc get() = document
}