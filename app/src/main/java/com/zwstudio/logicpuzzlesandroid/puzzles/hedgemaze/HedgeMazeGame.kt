...
class HedgeMazeGame(layout: List<String>, gi: GameInterface<HedgeMazeGame, HedgeMazeGameMove, HedgeMazeGameState>, gdi: GameDocumentInterface) : CellsGame<HedgeMazeGame, HedgeMazeGameMove, HedgeMazeGameState>(gi, gdi) {
    companion object {
    ...
    operator fun set(row: Int, col: Int, obj: HedgeMazeObject) {objArray[row * cols + col] = obj}
    ...
    init {
        ...
        objArray = Array(rows * cols) { HedgeMazeObject.Empty }
