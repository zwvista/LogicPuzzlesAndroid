...
open class FillominoGameActivity : GameGameActivity<FillominoGame?, FillominoDocument?, FillominoGameMove?, FillominoGameState?>() {
    @kotlin.jvm.JvmField
    @Bean
    ...
    override fun startGame() {
        ...
        game = FillominoGame(level.layout, this, doc())
        try {
            // restore game state
