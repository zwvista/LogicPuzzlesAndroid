...
class BattleShipsGameView(context: Context, val soundManager: SoundManager) : CellsGameView(context) {
            ...
            for (c in 0 until cols) {
                ...
                when (game.getObject(r, c)) {
                    ...
                    BattleShipsObject.Marker ->
                        canvas.drawArc((cwc2(c) - 10).toFloat(), (chr2(r) - 10).toFloat(), (cwc2(c) + 10).toFloat(), (chr2(r) + 10).toFloat(), 0f, 360f, true, paint)
