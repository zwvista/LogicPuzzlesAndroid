...
class InsaneTatamisMainActivity : GameMainActivity<InsaneTatamisGame, InsaneTatamisDocument, InsaneTatamisGameMove, InsaneTatamisGameState>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOptions.setOnClickListener {
            startActivity(Intent(this, InsaneTatamisOptionsActivity::class.java))
        }
    }

    override fun resumeGame() {
        doc.resumeGame()
        startActivity(Intent(this, InsaneTatamisGameActivity::class.java))
    }
}

class InsaneTatamisOptionsActivity : GameOptionsActivity<InsaneTatamisGame, InsaneTatamisDocument, InsaneTatamisGameMove, InsaneTatamisGameState>() {
    private val document: InsaneTatamisDocument by inject()
    override val doc get() = document
...
class InsaneTatamisHelpActivity : GameHelpActivity<InsaneTatamisGame, InsaneTatamisDocument, InsaneTatamisGameMove, InsaneTatamisGameState>() {
    private val document: InsaneTatamisDocument by inject()
    override val doc get() = document
}