...
class TrebuchetGameView(context: Context, val soundManager: SoundManager) : CellsGameView(context) {
    private val activity get() = context as TrebuchetGameActivity
    ...
    private val dTrebuchet: Drawable
    private val dTarget: Drawable
    ...
    init {
        ...
        dTrebuchet = fromImageToDrawable("images/trebuchet.png")
        dTarget = fromImageToDrawable("images/target.png")
    }
...
//        canvas.drawColor(Color.BLACK);
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        if (event.action == MotionEvent.ACTION_DOWN && !game.isSolved) {
            ...
            val move = TrebuchetGameMove(Position(row, col))
