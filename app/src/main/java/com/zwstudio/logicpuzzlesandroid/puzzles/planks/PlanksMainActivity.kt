...
class PlanksMainActivity : GameMainActivity<PlanksGame, PlanksDocument, PlanksGameMove, PlanksGameState>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOptions.setOnClickListener {
            startActivity(Intent(this, PlanksOptionsActivity::class.java))
        }
    }

    override fun resumeGame() {
        doc.resumeGame()
        startActivity(Intent(this, PlanksGameActivity::class.java))
    }
}

class PlanksOptionsActivity : GameOptionsActivity<PlanksGame, PlanksDocument, PlanksGameMove, PlanksGameState>() {
    private val document: PlanksDocument by inject()
    override val doc get() = document
...
class PlanksHelpActivity : GameHelpActivity<PlanksGame, PlanksDocument, PlanksGameMove, PlanksGameState>() {
    private val document: PlanksDocument by inject()
    override val doc get() = document
}