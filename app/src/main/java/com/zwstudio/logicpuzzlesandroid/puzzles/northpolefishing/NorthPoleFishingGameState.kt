...
class NorthPoleFishingGameState(game: NorthPoleFishingGame) : CellsGameState<NorthPoleFishingGame, NorthPoleFishingGameMove, NorthPoleFishingGameState>(game) {
    val objArray: Array<Array<GridLineObject>> = cloner.deepClone(game.dots.objArray)
    ...
    override fun setObject(move: NorthPoleFishingGameMove): GameOperationType {
        val p1 = move.p
        val dir = move.dir
        val dir2 = (dir + 2) % 4
    ...
    override fun switchObject(move: NorthPoleFishingGameMove): GameOperationType {
