...
class FreePlanksMainActivity : GameMainActivity<FreePlanksGame, FreePlanksDocument, FreePlanksGameMove, FreePlanksGameState>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOptions.setOnClickListener {
            startActivity(Intent(this, FreePlanksOptionsActivity::class.java))
        }
    }

    override fun resumeGame() {
        doc.resumeGame()
        startActivity(Intent(this, FreePlanksGameActivity::class.java))
    }
}

class FreePlanksOptionsActivity : GameOptionsActivity<FreePlanksGame, FreePlanksDocument, FreePlanksGameMove, FreePlanksGameState>() {
    private val document: FreePlanksDocument by inject()
    override val doc get() = document
...
class FreePlanksHelpActivity : GameHelpActivity<FreePlanksGame, FreePlanksDocument, FreePlanksGameMove, FreePlanksGameState>() {
    private val document: FreePlanksDocument by inject()
    override val doc get() = document
}