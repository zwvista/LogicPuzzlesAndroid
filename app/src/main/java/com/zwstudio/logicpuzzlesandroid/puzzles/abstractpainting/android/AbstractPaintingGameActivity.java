...
public class AbstractPaintingGameActivity extends GameGameActivity<AbstractPaintingGame, AbstractPaintingDocument, AbstractPaintingGameMove, AbstractPaintingGameState> {
    @Bean
    protected AbstractPaintingDocument document;
    public AbstractPaintingDocument doc() {return document;}

    protected AbstractPaintingGameView gameView;
    protected View getGameView() {return gameView;}

    @AfterViews
    protected void init() {
        gameView = new AbstractPaintingGameView(this);
        super.init();
    }
    ...
    protected void startGame() {
        ...
        game = new AbstractPaintingGame(level.layout, this, doc());
        try {
            // restore game state
            for (MoveProgress rec : doc().moveProgress()) {
                AbstractPaintingGameMove move = doc().loadMove(rec);
                game.setObject(move);
            }
