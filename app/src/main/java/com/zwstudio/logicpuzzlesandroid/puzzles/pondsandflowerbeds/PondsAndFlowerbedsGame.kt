...
class PondsAndFlowerbedsGame(layout: List<String>, gi: GameInterface<PondsAndFlowerbedsGame, PondsAndFlowerbedsGameMove, PondsAndFlowerbedsGameState>, gdi: GameDocumentInterface) : CellsGame<PondsAndFlowerbedsGame, PondsAndFlowerbedsGameMove, PondsAndFlowerbedsGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = PondsAndFlowerbedsGameState(this)
