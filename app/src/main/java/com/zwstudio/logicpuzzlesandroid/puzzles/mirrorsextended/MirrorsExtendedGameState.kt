...
class MirrorsExtendedGameState(game: MirrorsExtendedGame) : CellsGameState<MirrorsExtendedGame, MirrorsExtendedGameMove, MirrorsExtendedGameState>(game) {
    ...
    override fun switchObject(move: MirrorsExtendedGameMove): GameOperationType {
        ...
        move.obj = when (val o = this[p]) {
            MirrorsExtendedObject.Empty -> if (markerOption == MarkerOptions.MarkerFirst) MirrorsExtendedObject.Marker else MirrorsExtendedObject.Water
            MirrorsExtendedObject.Water -> if (markerOption == MarkerOptions.MarkerLast) MirrorsExtendedObject.Marker else MirrorsExtendedObject.Empty
            MirrorsExtendedObject.Marker -> if (markerOption == MarkerOptions.MarkerFirst) MirrorsExtendedObject.Water else MirrorsExtendedObject.Empty
            else -> o
        }
