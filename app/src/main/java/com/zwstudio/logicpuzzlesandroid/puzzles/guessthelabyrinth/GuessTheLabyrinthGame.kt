...
class GuessTheLabyrinthGame(layout: List<String>, gi: GameInterface<GuessTheLabyrinthGame, GuessTheLabyrinthGameMove, GuessTheLabyrinthGameState>, gdi: GameDocumentInterface) : CellsGame<GuessTheLabyrinthGame, GuessTheLabyrinthGameMove, GuessTheLabyrinthGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = GuessTheLabyrinthGameState(this)
