...
public class TierraDelFuegoGameActivity extends GameGameActivity<TierraDelFuegoGame, TierraDelFuegoDocument, TierraDelFuegoGameMove, TierraDelFuegoGameState> {
    @Bean
    protected TierraDelFuegoDocument document;
    public TierraDelFuegoDocument doc() {return document;}

    protected TierraDelFuegoGameView gameView;
    protected View getGameView() {return gameView;}

    @AfterViews
    protected void init() {
        gameView = new TierraDelFuegoGameView(this);
        super.init();
    }
    ...
    protected void startGame() {
        ...
        game = new TierraDelFuegoGame(level.layout, this, doc());
        try {
            // restore game state
            for (MoveProgress rec : doc().moveProgress()) {
                TierraDelFuegoGameMove move = doc().loadMove(rec);
                game.setObject(move);
            }
