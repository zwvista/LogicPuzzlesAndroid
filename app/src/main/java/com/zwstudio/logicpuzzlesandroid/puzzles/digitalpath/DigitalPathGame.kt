...
class DigitalPathGame(layout: List<String>, gi: GameInterface<DigitalPathGame, DigitalPathGameMove, DigitalPathGameState>, gdi: GameDocumentInterface) : CellsGame<DigitalPathGame, DigitalPathGameMove, DigitalPathGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = DigitalPathGameState(this)
