...
class SheepAndWolvesMainActivity : GameMainActivity<SheepAndWolvesGame, SheepAndWolvesDocument, SheepAndWolvesGameMove, SheepAndWolvesGameState>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOptions.setOnClickListener {
            startActivity(Intent(this, SheepAndWolvesOptionsActivity::class.java))
        }
    }

    override fun resumeGame() {
        doc.resumeGame()
        startActivity(Intent(this, SheepAndWolvesGameActivity::class.java))
    }
}

class SheepAndWolvesOptionsActivity : GameOptionsActivity<SheepAndWolvesGame, SheepAndWolvesDocument, SheepAndWolvesGameMove, SheepAndWolvesGameState>() {
    private val document: SheepAndWolvesDocument by inject()
    override val doc get() = document
...
class SheepAndWolvesHelpActivity : GameHelpActivity<SheepAndWolvesGame, SheepAndWolvesDocument, SheepAndWolvesGameMove, SheepAndWolvesGameState>() {
    private val document: SheepAndWolvesDocument by inject()
    override val doc get() = document
}