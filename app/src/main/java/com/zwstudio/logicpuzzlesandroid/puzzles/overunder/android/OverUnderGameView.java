...
public class OverUnderGameView extends CellsGameView {
    ...
    private OverUnderGame game() {return activity().game;}
    ...
    public OverUnderGameView(Context context) {
        super(context);
        init(null, 0);
    }

    public OverUnderGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public OverUnderGameView(Context context, AttributeSet attrs, int defStyle) {
...
//        canvas.drawColor(Color.BLACK);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN && !game().isSolved()) {
            ...
            OverUnderGameMove move = new OverUnderGameMove() {{
