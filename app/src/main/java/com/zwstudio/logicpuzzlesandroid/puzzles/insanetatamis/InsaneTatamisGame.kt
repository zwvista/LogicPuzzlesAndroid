...
class InsaneTatamisGame(layout: List<String>, gi: GameInterface<InsaneTatamisGame, InsaneTatamisGameMove, InsaneTatamisGameState>, gdi: GameDocumentInterface) : CellsGame<InsaneTatamisGame, InsaneTatamisGameMove, InsaneTatamisGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = InsaneTatamisGameState(this)
