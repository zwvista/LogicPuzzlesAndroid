...
class MixedTatamisGame(layout: List<String>, gi: GameInterface<MixedTatamisGame, MixedTatamisGameMove, MixedTatamisGameState>, gdi: GameDocumentInterface) : CellsGame<MixedTatamisGame, MixedTatamisGameMove, MixedTatamisGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = MixedTatamisGameState(this)
