...
class FlowerOMinoGame(layout: List<String>, gi: GameInterface<FlowerOMinoGame, FlowerOMinoGameMove, FlowerOMinoGameState>, gdi: GameDocumentInterface) : CellsGame<FlowerOMinoGame, FlowerOMinoGameMove, FlowerOMinoGameState>(gi, gdi) {
    companion object {
    ...
    operator fun set(row: Int, col: Int, obj: FlowerOMinoObject) {objArray[row * cols + col] = obj}
    operator fun set(p: Position, obj: FlowerOMinoObject) {this[p.row, p.col] = obj}
    ...
    init {
        ...
        val state = FlowerOMinoGameState(this)
