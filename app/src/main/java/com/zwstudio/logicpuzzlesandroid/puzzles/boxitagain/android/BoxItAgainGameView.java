...
public class BoxItAgainGameView extends CellsGameView {
    ...
    private BoxItAgainGame game() {return activity().game;}
    ...
    public BoxItAgainGameView(Context context) {
        super(context);
        init(null, 0);
    }

    public BoxItAgainGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public BoxItAgainGameView(Context context, AttributeSet attrs, int defStyle) {
...
//        canvas.drawColor(Color.BLACK);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN && !game().isSolved()) {
            ...
            BoxItAgainGameMove move = new BoxItAgainGameMove() {{
