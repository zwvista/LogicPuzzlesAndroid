...
class LiarLiarGame(layout: List<String>, gi: GameInterface<LiarLiarGame, LiarLiarGameMove, LiarLiarGameState>, gdi: GameDocumentInterface) : CellsGame<LiarLiarGame, LiarLiarGameMove, LiarLiarGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = LiarLiarGameState(this)
