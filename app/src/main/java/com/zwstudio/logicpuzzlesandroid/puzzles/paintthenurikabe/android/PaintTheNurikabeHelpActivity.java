...
public class PaintTheNurikabeHelpActivity extends GameHelpActivity<PaintTheNurikabeGame, PaintTheNurikabeDocument, PaintTheNurikabeGameMove, PaintTheNurikabeGameState> {
    @Bean
