...
public class FenceItUpGameView extends CellsGameView {

    private FenceItUpGameActivity activity() {return (FenceItUpGameActivity)getContext();}
    private FenceItUpGame game() {return activity().game;}
    ...
    public FenceItUpGameView(Context context) {
        super(context);
        init(null, 0);
    }

    public FenceItUpGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public FenceItUpGameView(Context context, AttributeSet attrs, int defStyle) {
...
//        canvas.drawColor(Color.BLACK);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN && !game().isSolved()) {
            ...
            FenceItUpGameMove move = new FenceItUpGameMove() {{
