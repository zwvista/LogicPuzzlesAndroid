...
public class FenceSentinelsOptionsActivity extends GameOptionsActivity<FenceSentinelsGame, FenceSentinelsDocument, FenceSentinelsGameMove, FenceSentinelsGameState> {
    @Bean
