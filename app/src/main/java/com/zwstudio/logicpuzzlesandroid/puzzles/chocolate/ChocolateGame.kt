...
class ChocolateGame(layout: List<String>, gi: GameInterface<ChocolateGame, ChocolateGameMove, ChocolateGameState>, gdi: GameDocumentInterface) : CellsGame<ChocolateGame, ChocolateGameMove, ChocolateGameState>(gi, gdi) {
    companion object {
    ...
    init {
        ...
        val state = ChocolateGameState(this)
