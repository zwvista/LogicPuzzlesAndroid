...
class UnseenMainActivity : GameMainActivity<UnseenGame, UnseenDocument, UnseenGameMove, UnseenGameState>() {
    private val document: UnseenDocument by inject()
    override val doc get() = document

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding.btnOptions.setOnClickListener {
            startActivity(Intent(this, UnseenOptionsActivity::class.java))
        }
    }

    override fun resumeGame() {
        doc.resumeGame()
        startActivity(Intent(this, UnseenGameActivity::class.java))
    }
}

class UnseenOptionsActivity : GameOptionsActivity<UnseenGame, UnseenDocument, UnseenGameMove, UnseenGameState>() {
    private val document: UnseenDocument by inject()
    override val doc get() = document
...
class UnseenHelpActivity : GameHelpActivity<UnseenGame, UnseenDocument, UnseenGameMove, UnseenGameState>() {
    private val document: UnseenDocument by inject()
    override val doc get() = document
}