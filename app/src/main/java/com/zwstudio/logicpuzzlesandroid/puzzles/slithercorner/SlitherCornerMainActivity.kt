...
class SlitherCornerMainActivity : GameMainActivity<SlitherCornerGame, SlitherCornerDocument, SlitherCornerGameMove, SlitherCornerGameState>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOptions.setOnClickListener {
            startActivity(Intent(this, SlitherCornerOptionsActivity::class.java))
        }
    }

    override fun resumeGame() {
        doc.resumeGame()
        startActivity(Intent(this, SlitherCornerGameActivity::class.java))
    }
}

class SlitherCornerOptionsActivity : GameOptionsActivity<SlitherCornerGame, SlitherCornerDocument, SlitherCornerGameMove, SlitherCornerGameState>() {
    private val document: SlitherCornerDocument by inject()
    override val doc get() = document
...
class SlitherCornerHelpActivity : GameHelpActivity<SlitherCornerGame, SlitherCornerDocument, SlitherCornerGameMove, SlitherCornerGameState>() {
    private val document: SlitherCornerDocument by inject()
    override val doc get() = document
}