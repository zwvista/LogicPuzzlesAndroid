        ...
        for (r in 0..<rows)
            for (c in 0..<cols) {
                ...
                when (val o = game.getObject(p)) {
                    ...
                    MineShipsObject.BattleShipRight -> {
                    ...
                    MineShipsObject.BattleShipBottom -> {
