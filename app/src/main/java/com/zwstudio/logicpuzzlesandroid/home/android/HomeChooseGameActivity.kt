...
class HomeChooseGameActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private var name2title = mapOf(
            ...
            "CloudsAndClears" to "Clouds and Clears",
            ...
            "LoopAndBlocks" to "Loop and Blocks",
            "MakeTheDifference" to "Make the Difference",
            "MineSlither" to "MineSlither",
            "MiniLits" to "Mini-Lits",
            "NoughtsAndCrosses" to "Noughts & Crosses",
            "NumberLink" to "NumberLink",
            "PathOnTheHills" to "Path on the Hills",
            "PathOnTheMountains" to "Path on the Mountains",
            "PleaseComeBack" to "Please come back",
            ...
            "StraightAndBendLands" to "Straight and Bend Lands",
            "StraightAndTurn" to "Straight and Turn",
            "TapAlike" to "Tap-Alike",
            "TapARow" to "Tap-A-Row",
            "TurnMeUp" to "Turn me up",
            "UnreliableHints" to "Unreliable hints",
            "YouTurnMeOn" to "You Turn me on",
        )
